package com.fourweekdays.fourweekdays.search.controller.service;
...
import com.fourweekdays.fourweekdays.search.controller.repository.SearchRepository;
...
public class UnifiedSearchService {
     ...
     * 검색 결과 개수만 조회
     */
    public long count(SearchRequest condition) {
        SearchHits<ProductSearchDocument> searchHits = 
            unifiedSearchRepository.unifiedSearch(condition);
